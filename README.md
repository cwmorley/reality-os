...
- **[`ARCHITECTURE.md`](./ARCHITECTURE.md)** — the full write-up: bounded context loading, the cooperative write lock, cross-agent question routing and reconciliation, epistemic discipline, and an honest account of where the system's own rules were tested and where they slipped.
